...
<p align="center">
  ...
  <img src="shots/home.png" width="220" alt="首页：上次框选的内容">
  <img src="shots/detail_cached.png" width="220" alt="解释详情，标题下标注「已缓存 · 没有再请求模型」">
  <img src="shots/kb_final.png" width="220" alt="知识库：按拼音首字母分组">
</p>

<p align="center"><sub>左起：圆点常驻在别的应用之上 · 首页 · 命中本地库的解释 · 知识库</sub></p>
...
| 3 | **看概念列表** | 松手即截图，结果直接落在首页：这页里那几个词值得解释 |
| 4 | **点进去读** | 解释按「义项」分节。正文里其他概念是可点链接，底部还有「对话理解」 |

途中随时能按系统返回键往回走，回到上一层的概念——跳转历史是一整条栈，
可以 A→B→C 再按三次返回依次退回。钻深了还有「换一个概念」一次弹到底。
...
| **无障碍服务** | 系统设置 → 无障碍 → 框选解释 · 屏幕取图 | 唯一的截屏通路，不开就框不出图 |
...
本仓库暂未附带开源许可证，按默认即「保留所有权利」。
如果打算让别人使用或修改，可以自行加一份 MIT 或 Apache-2.0。
